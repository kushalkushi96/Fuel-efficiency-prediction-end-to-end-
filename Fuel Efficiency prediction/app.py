...
def result():
    ...
    scaler_path=os.path.join(os.path.dirname('E:/kushi/My projects/fuel eff/models/') ,'scaler.pkl')
    ...
    model=load_model(r"E:\kushi\My projects\fuel eff\models\model.h5")
